...
const updateProfile = async (req, res) => {
  try {
    ...
    if (imageFile) {
      // upload img to cloudnery

      const imageUpload = await cloudnery.uploader.upload(imageFile.path, {
        resource_type: "image",
      });
