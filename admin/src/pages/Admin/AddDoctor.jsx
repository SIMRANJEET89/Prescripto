      ...
      <div className="bg-white px-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            <div className="flex-1 flex flex-col gap-1">
                ...
                <select onChange={(e)=>setSpeciality(e.target.value)} value={speciality} className="border rounded px-3 py-2" name="" id="">
                    ...
                    <option value="Deramtologist">Deramtologist</option>
         ...
         <div>
            ...
            <button type="submit" className="bg-blue-500 cursor-pointer px-10 py-3 mt-4 text-white rounded-full">Add doctor</button>
      </div>
    </form>
  );
};
